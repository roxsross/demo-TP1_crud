     ...
     <div class="content-wrapper">
       ...
       <section class="content">
         ...
         <div class="card-header">
           <h3 class="card-title"><b>Nuevos datos</b></h3>
         </div>
...
?>
           <form id="add_risk" name="nuevo" method="post" action="guardar.php">
             <div class="form-group row">
               <label for="staticEmail" class="col-sm-ggb col-form-label">Nombre:</label>
               <div class="col-sm-3">
                 <input type="text" class="form-control-ggb form-control" id="nombre" name="nombre">
               </div>
             </div>
             <div class="form-group row">
               <label for="staticEmail" class="col-sm-ggb col-form-label">Apellido:</label>
               <div class="col-sm-3">
                 <input type="text" class="form-control-ggb form-control" id="apellido" name="apellido">
               </div>
             </div>
             <div class="form-group row">
               <label for="staticEmail" class="col-sm-ggb col-form-label">DNI::</label>
               <div class="col-sm-3">
                 <input type="text" class="form-control-ggb form-control" id="dni" name="dni">
               </div>
             </div>
